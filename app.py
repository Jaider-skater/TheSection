...
def admin_authenticated():
    return admin_auth_configured() and session.get('admin_authenticated') is True
...
def protect_scanner_response():
    if not admin_auth_configured():
        message = 'Admin credentials are not configured. Set ADMIN_USERNAME and ADMIN_PASSWORD.'
